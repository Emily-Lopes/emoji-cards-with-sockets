...
from telas.criarConta import CriarConta
...
class Login(arcade.View):
    ...
    def setup(self):
        ...
        self.b_login = arcade.load_texture("./imagens/botoes/b-login.png")
        self.fundo_campo_nome = arcade.load_texture("./imagens/campo.png")
        self.fundo_campo_senha = arcade.load_texture("./imagens/campo.png")
